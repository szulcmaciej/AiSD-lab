 ...
 */
public class HeapSortServiceTest {
    ...
    public void shouldSortListOfDoubles(){
        ...
        //Act
        List<Double> sortedList = HeapSortService.sort(list, naturalComparator).getResult();
    ...
    public void shouldReturnSameListOnSortedList(){
        ...
        //Act
        HeapSortService.sort(list, naturalComparator);
